 ...
 */
public class BenimAlgoritmaSorum2 {
   int buyucu_guc=10;
   int savasci_guc=15;
   int okcu_guc=20;
...
public void Tumislemler(){
        ...
        case 1 :
            Karakterler nesne=new Karakterler("buyucu",1,10,1,10);
           System.out.println("Sectiginiz Karakter : " +nesne.Meslek+",Gucu : "+buyucu_guc);
           Karakter_Yarat obj=new Karakter_Yarat(nesne.Meslek, 1, buyucu_guc,1,buyucu_guc);
           System.out.println("****************************************************");
           ...
           int girdi=read.nextInt();
            ...
            case 2:
                Karakterler nesne2=new Karakterler("okcu",1,20,1,20);
           System.out.println("Sectiginiz Karakter : " +nesne2.Meslek+",Gucu : "+okcu_guc);
           Karakter_Yarat obj2=new Karakter_Yarat(nesne2.Meslek, 1, okcu_guc,1,okcu_guc);
           System.out.println("****************************************************");
           System.out.println("Karakterini sectigine gore artik oyuna baslayabiliriz ");
           Girdiiste();
           int girdi2=read.nextInt();
            ...
            break;
                ...
                case 3:
           Karakterler nesne3=new Karakterler("savasci",1,15,1,15);
           System.out.println("Sectiginiz Karakter : " +nesne3.Meslek+",Gucu : "+savasci_guc);
           Karakter_Yarat obj3=new Karakter_Yarat(nesne3.Meslek, 1, savasci_guc,1,savasci_guc);
           System.out.println("****************************************************");
           System.out.println("Karakterini sectigine gore artik oyuna baslayabiliriz ");
           Girdiiste();
    ...
    public static void main(String[] args) {
        ...
        BenimAlgoritmaSorum2 nesnesi=new BenimAlgoritmaSorum2();
        nesnesi.Tumislemler();
...
public class Karakterler{
    ...
    //default degerleri aktardık
    }
    public Karakterler(String Meslek,int Seviye,int Guc,int YeniSeviye,int YeniGuc){//Yapici Method'um
    this.Meslek=Meslek;
    this.Seviye=1;
    this.Guc=Guc;
    this.YeniSeviye=Seviye+YeniSeviye;
    this.YeniGuc=Guc+YeniGuc;
    }
    ...
    return  Guc;
     ...
     public void setSeviye(int YeniSeviye){
